...
#####52 is still an intimidating number of variables. So taking inspiration from machine learning algorithms that sample and resample data sets, I ran pairs plots of subsets of my data (Figure 1) to glimpse potential relationships in the data.
...
#####There did not appear to be any linear relationships among my initial predictors, so I employed a decision tree algorithm (32% accuracy), then a linear discriminant analysis model (52%), and ultimately bagging.
